...
#pg.mixer.init()
#pg.mixer.music.load("/home/pi/Desktop/sound.mp3")
#time.sleep(25)
...
buf=''
HOST = '10.1.1.113'  # this is your localhost
PORT = 8888
try :
...
#s.close()
#socket.socket: must use to create a socket. socket.SOCK_STREAM,
